...
const Login: React.FC = () => {
  ...
  const handleReset = async (e: React.FormEvent) => {
    ...
    confirm({
      ...
      message:
        'Tindakan ini akan mengembalikan username dan password ke default (admin/admin). Gunakan hanya jika darurat.',
      variant: 'danger',
      ...
      <div className="bg-slate-900 border border-slate-800 rounded-2xl shadow-2xl w-full max-w-sm relative z-10 overflow-hidden">
        ...
        <div className="bg-slate-950 p-4 text-center border-t border-slate-800">
          <p className="text-[10px] text-slate-600 leading-tight">
            PT. Redone Berkah Mandiri Utama &copy; 2026
            <br />
            All Rights Reserved.
          </p>
        </div>
        ...
        <form onSubmit={handleReset} className="space-y-4">
          <div className="bg-amber-950/30 border border-amber-900/50 p-3 rounded-lg flex gap-3">
            ...
            <p className="text-xs text-amber-300">
              Fitur ini digunakan untuk mereset akun admin kembali ke default (admin/admin).
              Masukkan kode rahasia perusahaan untuk melanjutkan.
            </p>
          </div>
          <Input
            label="Kode Rahasia"
